...
<!-- .slide: data-background-image="assets/spellbook.gif" -->
...
## Cosa fa di base un modello MLP?

**A**) Il modello impara esclusivamente le regole grammaticali  

**B**) Il modello memorizza fatti specifici e relazioni, come l'associazione tra "Michael Jordan" e "basketball"  

**C**) Il modello generalizza senza mai ricordare dati specifici  

**D**) Il modello dimentica informazioni non rilevanti durante l'addestramento  
...
## Qual è lo scopo della "Residual Addition" in un MLP?

**A**) Aggiungere rumore casuale per migliorare la generalizzazione  

**B**) Sommare il risultato delle trasformazioni intermedie all'input originale per preservare informazioni 

**C**) Moltiplicare l'input originale per aumentare la complessità computazionale  

**D**) Sostituire l'input originale con il risultato del blocco MLP  
...
## Cosa avviene durante il processamento parallelo in un MLP?

**A**) I vettori vengono combinati in un'unica rappresentazione condivisa  

**B**) Ogni vettore viene processato indipendentemente attraverso lo stesso insieme di operazioni  

**C**) Viene eseguita una media pesata di tutti i vettori per ottenere l'output finale  

**D**) I vettori vengono ordinati in sequenza per successive elaborazioni  
...
## Quale funzione di attivazione non lineare è comunemente usata in un MLP?
...
## Qual è il ruolo delle proiezioni in un MLP?

**A**) Aumentare/diminuire la dimensionalità dell'output rispetto all'input  

**B**) Proiettare il vettore su uno spazio con dimensione maggiore/uguale a quella dell'embedding  

**C**) Applicare una trasformazione non lineare per attivare i neuroni  

**D**) Sommare bias al vettore per incrementare la complessità  

Notes:  
B

--![alt text](../2024-03-28/assets/backprop-title.gif)

## Cosa si intende per attivazione neuronale in un MLP?

**A**) L'attivazione simultanea di tutti i neuroni senza distinzione  

**B**) La decisione di ciascun neurone di trasmettere o meno il segnale basata sul risultato della funzione di attivazione  

**C**) L'inibizione dei neuroni non necessari per ridurre il rumore  

**D**) La normalizzazione dei valori di attivazione su tutto il vettore  
